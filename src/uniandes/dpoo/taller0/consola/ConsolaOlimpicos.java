...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país que representa un atleta determinado:");
	...
	/**
	 * Este método le pide al usuario el nombre del deportista y retorna el país al cual representa.
	 * 
	 *
	 */
	private void consultarPaisDeAtleta() {
	    System.out.println("\n" + "Consultar país que representa un atleta determinado" + "\n");
	    
	    String nombreAtleta = input("Por favor ingrese el nombre del atleta");
	    Pais paisRepresentado = calculadora.paisDeAtleta(nombreAtleta);

	    if (paisRepresentado != null) {
	        System.out.println(nombreAtleta + " representa a " + paisRepresentado.darNombre());
	    } else {
	        System.out.println("No se encontró información sobre el atleta " + nombreAtleta);
	    }
	}
