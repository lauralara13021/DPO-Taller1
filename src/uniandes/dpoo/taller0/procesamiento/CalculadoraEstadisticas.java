...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Busca el país que representa a un atleta.
	 * 
	 * @param nombreAtleta El nombre del atleta cuyo país de origen se quiere buscar.
	 * @return El país que representa al atleta según su origen, o null si el atleta no se encuentra en la lista.
	 */
